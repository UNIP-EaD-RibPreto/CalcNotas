function selecaoItens() {
  ...
  /*
     ...
     mostrarSecao('secaoAva', tipoDisciplina === 'praticaLaboratorio');
  ...
  if (dp === "dp") {
    switch (tipoDisciplina) {
      ...
      case "teoricaTecnologica":
        mostrarSecao("secaoProvas", tipoDisciplina === "teoricaTecnologica");
        break;
    }
  } else {
    // Implementar cálculo para Disciplinas regulares
    switch (tipoDisciplina) {
      case "teoricaTradicional":
        mostrarSecao("secaoProvas", tipoDisciplina === "teoricaTradicional");
        break;
